      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              src="https://online-project-images.s3.us-east-2.amazonaws.com/dentalpro/logo.png"
              width="50"
              height="50"
              alt="Dental Pro"
              style={logo}
            />
            <Text style={logoText}>Dental Pro</Text>
          </Section>
          ...
          <Text style={footerText}>
            If you have any questions, please contact us at support@Dental
            Pro.com
          </Text>
        </Container>
      </Body>
